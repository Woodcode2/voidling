...
const SUITE = [
  ...
  { id: 'dangerchannel', tier: 'feel', profiles: ['live', 'quality'], timeout: 3000,
    ...
    why: 'alert() and the red wash answer only a charge, a bite or the danger teach — not a sibling joining, a lost lead or a tapped padlock — one flash a frame, and the charge washes red from her side of the screen' },
