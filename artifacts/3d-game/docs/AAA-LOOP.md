...
| B3, B4 / Job 4 | Walking people's eyes buried by hair shells and caps | MOTION | **Geometry DONE, frame read OWED** — qa/faceray.mjs (new, node: runs life.ts's own head code through the TS compiler and raycasts each eye from 46/55/65°): (E) before **FAIL**, 120 of 126 Hair x Hat under 50% of an eye (shared crown 0/0/0 on 10 of 14 hair draws, buzz 43/42/41, curly 55/53/52, every hat 0/0/0); after **PASS**, 162 built, lowest reading outside the conventions 69% (beanie at 65°). Hair shells −0.55 (the governor's number), cap/postal crown and the skeptic's visor as specified; beanie, bandana, hood, flower, visor, bucket, tricorn, helmet and shako tipped to the hairline by sweep (each value and its rejected neighbour in the life.ts comment). Sun, straw, captain exempt by the governor's convention; **snorkel exempt too** (a dive mask is the eyes, as sunglasses already are) — a call beyond the spec. (H) hat colour dE > 15 from shirt and skin: before 132 skin + 128 shirt collisions over 528 pairs (cream on the palest skin, dE 7.1), after 0, closest 17.2. Curly under a hat is drawn short: −840 tris (5 × 168; the spec's 960 was 2·W·H). qa/_headcover.mjs hardened (eye parsed, ninth argument parsed, exits 1): before **FAIL** (crown and hood swallow the eye), after **PASS**, scalp still 0.0% bare. Both join push. **Owed:** `node qa/faceline.mjs 4177 maple` (I-3 line-up, written, never run) and a person reading its frames |
