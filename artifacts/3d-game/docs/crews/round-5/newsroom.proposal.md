...
| world | cards AIRED / 26 | distinct | repeats | opener run | pools reached | from the new pools |
|---|---|---|---|---|---|---|
| lantern | **26** | **26** | **0** | 3 | 6 | LIVE 8, MEAL 3 — **11 of 26** |
| powder | **26** | **26** | **0** | 3 | 6 | LIVE 4, MEAL 3 — **7 of 26** |
...
`node qa/gate.mjs --profile=push --port=4177` — **PASS, 20/20**. Two new steps in the words
tier: `newsfeed` (the aired sequence, SEED pinned so a failure is reproducible rather than a
