...
const GENERAL: Pools = [[
  ...
  'Is that a hole on Elm Street, or is it a drainage feature?',
  ...
  'Dale mowed around a hole in his lawn and did not mention it.',
  ...
  'Deb Hollis heard about the hole first and has told eleven people.',
  ...
  'Town hall met for four hours about a hole and decided to meet again.',
  ...
  'Have an ice cream, says the mayor, and stop asking about the hole.',
  ...
  'The mayor says there is no hole and please stay away from the hole.',
  ...
  'Is that a second hole by the water tower? Yes. Yes it is.',
  ...
  'And now the weather: sunny, mild, and over a very large purple hole.',
