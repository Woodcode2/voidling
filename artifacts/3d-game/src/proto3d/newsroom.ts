...
const GENERAL: Pools = [[
  ...
  'Maisie says there is a void by the pool. Staff gave her a smoothie.',
  ...
  'The conga line has rerouted around the void and carries on.',
  ...
  'The cannon fired a beach ball at the void. The void ate the ball.',
  'Lounger nine has gone, halfway through its eleventh year.',
  'Two hundred guests are speed-walking to the boats, very elegantly.',
  'The Gilded Lagoon is advertising void-free weekends. How smug.',
  'The water slide queue moved at last. So did the water slide.',
  'Kids club at three is waving at the void from a very safe distance.',
  ...
  'A guest asked if the void takes bookings. Nigel said yes, for August.',
  ...
  'There are two purple voids now. We are not discussing the second one.',
  'Cressida Vane gave the void two stars for taking her starter.',
], [
  ...
  'Barnaby has been saying void since breakfast. Barnaby is unbearable.',
  ...
  'One beach ball came back out of the void. Nobody has claimed it.',
  'Correction: there are three purple voids now, not two.',
  ...
  'Every child in kids club has drawn a picture of the void.',
...
const LIVE: Pools = [[
  ...
  'The pool at {D} has a void. Capt. Roger calls that two pools.',
...
function bind(ctx: NewsCtx): Filled {
  ...
  return {
    ...
    meal: clip(fragment(ctx.lastMeal || 'the buffet'), 22),
